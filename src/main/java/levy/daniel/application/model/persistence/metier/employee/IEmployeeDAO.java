...
public interface IEmployeeDAO {
	 ...
	 * @throws Exception
	 */
	IEmployee create(IEmployee pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	IEmployee createOrRetrieve(IEmployee pEntity) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(IEmployee pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IEmployee pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;IEmployee&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;IEmployee&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<IEmployee> saveIterable(Iterable<IEmployee> pList) 
				throws Exception;
	 ...
	 * @throws Exception
	 */
	IEmployee retrieve(IEmployee pObject) throws Exception;
	 ...
	 * 
	 * @return : IEmployee : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	IEmployee findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IEmployee pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IEmployee> rechercherRapide(
	 ...
	 * @throws Exception
	 */
	List<IEmployee> findAll() throws Exception;
	 ...
	 * (List&lt;IEmployee&gt;) dont les IDs appartiennent 
	 ...
	 * @throws Exception 
	 */
	Iterable<IEmployee> findAllIterable(Iterable<Long> pIds) throws Exception;
	 ...
	 * @throws Exception 
	 */
	IEmployee update(IEmployee pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IEmployee : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IEmployee : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	IEmployee updateById(Long pId, IEmployee pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IEmployee : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IEmployee pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IEmployee> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IEmployee> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IEmployee : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IEmployee pObject) throws Exception;
	 ...
	 * retourne null si pList == null.<br/>
	 *
	 * @param pList : List&lt;IEmployee&gt;.<br/>
	 * 
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IEmployee> pList);
...
} // FIN DE L'INTERFACE IEmployeeDAO.----------------------------------------
