...
public interface IPersonDAO {
	 ...
	 * @throws Exception
	 */
	IPerson create(IPerson pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	IPerson createOrRetrieve(IPerson pEntity) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(IPerson pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IPerson pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	IPerson retrieve(IPerson pObject) throws Exception;
	 ...
	 * 
	 * @return : IPerson : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	IPerson findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IPerson pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	List<IPerson> findAll() throws Exception;
	 ...
	 * (List&lt;IPerson&gt;) dont les IDs appartiennent 
	 ...
	 * @throws Exception 
	 */
	Iterable<IPerson> findAllIterable(Iterable<Long> pIds) throws Exception;
	 ...
	 * @throws Exception 
	 */
	IPerson update(IPerson pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IPerson : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IPerson : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	IPerson updateById(Long pId, IPerson pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IPerson : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IPerson pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IPerson> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IPerson> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IPerson : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IPerson pObject) throws Exception;
	 ...
	 * retourne null si pList == null.<br/>
	 *
	 * @param pList : List&lt;IPerson&gt;.<br/>
	 * 
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IPerson> pList);
