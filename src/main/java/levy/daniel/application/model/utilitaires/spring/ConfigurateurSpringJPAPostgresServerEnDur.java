...
import levy.daniel.application.model.utilitaires.jpa.datasource.DataSourcePostgresHikariEnDur;
...
@Configuration(value="ConfigurateurSpringJPAPostgresServerEnDur")
...
public class ConfigurateurSpringJPAPostgresServerEnDur {
	...
	private static final Log LOG 
		= LogFactory.getLog(ConfigurateurSpringJPAPostgresServerEnDur.class);
	...
	*/
	public ConfigurateurSpringJPAPostgresServerEnDur() {
		super();
...
//		mutablePersistenceUnitInfo.addManagedPackage(packageName);
	...
	public DataSource dataSource() {
		...
		final HikariDataSource dataSource 
			= DataSourcePostgresHikariEnDur.getHikariDataSource();
