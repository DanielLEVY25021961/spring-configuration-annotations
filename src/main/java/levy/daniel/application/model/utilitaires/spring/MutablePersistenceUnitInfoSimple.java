...
/**
 * CLASSE MutablePersistenceUnitInfoSimple :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public class MutablePersistenceUnitInfoSimple 
	 ...
	 * (driver de connexion à la base) sont des Property 
	 * qui peuvent être spécifiées dans la DataSource ou dans 
	 * <code>this.properties</code>...</li>
	 * </ul>
	 */
	...
	private static final Log LOG 
		= LogFactory.getLog(MutablePersistenceUnitInfoSimple.class);
	 ...
	 */
	public MutablePersistenceUnitInfoSimple() {
	 ...
	 * CONSTRUCTEUR MALIN.
	 * <ul>
	 * <li>alimente <code><b>this.persistenceUnitName</b></code> 
	 * avec le paramètre.</li>
	 * <li>alimente <code><b>this.persistenceProviderClassName</b></code> 
	 * avec le paramètre.</li>
	 * <li></li>
	 * <li></li>
	...
	* si pClassLoader == null.</li>
	 ...
	 * DataSource fournie par le conteneur de Servlet (TOMCAT) via JNDI 
	 * en cas de transactions JTA.
	 * @param pNonJtaDataSource : DataSource : 
	 * DataSource de l'application Standalone en cas de 
	 * transactions RESOURCE_LOCAL (pas de TOMCAT).
	 * @param pManagedClassNames : List&lt;String&gt; : 
	 * liste des <b>noms</b> des classes Entities JPA mappées 
	 * pour management par JPA dans un persistence.xml.
	 * @param pProperties : Properties : 
	 * <b>propriétés de <b>connexion à la base</b> 
	 * éventuellement spécifiques à l'ORM, à SPRING, à H2, ...</b> 
	...
	public MutablePersistenceUnitInfoSimple(
		...
		this(
				...
				, pTransactionType
				, pJtaDataSource, pNonJtaDataSource,
				null, null, null
				, pManagedClassNames, null
				, false, null, null
				, pProperties
				, null, null, null, null);
...
//				this.persistenceProviderPackageName);
	 ...
	 * du contenu du present MutablePersistenceUnitInfoSimple</b>.<br/>
	 *
	...
	public final String toStringAmeliore() {
		...
		stb.append("*********** VALEURS dans LE CONTENEUR MutablePersistenceUnitInfoSimple de l'EntityManagerFactory *********** : ");
		...
		stb.append(SAUT_LIGNE_PLATEFORME);
		if (this.nonJtaDataSource != null) {
			stb.append(this.afficherDataSourceHikari((HikariDataSource) this.nonJtaDataSource));
		}
		...
		stb.append(SAUT_LIGNE_PLATEFORME);
		stb.append("LISTE DES PROPRIETES DANS LE java.util.Properties du MutablePersistenceUnitInfoSimple de l'EntityManagerFactory : ");
		stb.append(SAUT_LIGNE_PLATEFORME);
	 ...
	 * @return : String :  .<br/>
	 */
	public String afficherDataSourceHikari(
			final HikariDataSource pDataSource) {
		
		final StringBuilder builder = new StringBuilder();

		final String url = pDataSource.getJdbcUrl();
...
} // FIN DE LA CLASSE MutablePersistenceUnitInfoSimple.----------------------
